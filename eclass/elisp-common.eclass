...
elisp-site-regen() {
	local oldsum newsum sflist sf line

	einfo "Regenerating ${SITELISP}/site-gentoo.el ..."
	oldsum=$(md5sum ${ROOT}${SITELISP}/site-gentoo.el 2>/dev/null)
...
EOF
	...
	newsum=$(md5sum ${ROOT}${SITELISP}/site-gentoo.el)

	# suppress output if site-gentoo.el has not changed
